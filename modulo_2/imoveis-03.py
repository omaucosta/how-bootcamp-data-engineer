...
for house in houses:
        ...
        try:
            ...
            vagas = None
        try:
            valor = house.find('li', {'class': 'property-card__detail-garage'}).span.text.strip()
        except:
            valor = None
        try:
            condominio = house.find('li', {'class': 'property-card__detail-garage'}).span.text.strip()
        except:
            condominio = None
        try:
            wlink = house.find('li', {'class': 'property-card__detail-garage'}).span.text.strip()
        except:
            wlink = None

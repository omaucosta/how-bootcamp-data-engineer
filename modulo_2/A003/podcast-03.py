...
soup.find('h5').text
# %%
soup.find('h5').a # pegando apenas o que tem dentro da tag 'a'

#%%
soup.find('h5').a['href'] # pegando o conteudo de 'href'
# %%
...
for item in lst_podcast:
    ...
    # 'loc' => pegar uma posição, no caso a última
    # shape => retorna linhas e colunas do df
#%%
df.shape
